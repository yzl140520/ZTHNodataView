...
- (void)initSubviews{
    if (self.noDataImage) {
        ...
        CGFloat width = MIN(self.noDataImage.size.width, SCREEN_WIDTH);
    ...
    NSString* text = [ZTUtil safeString:self.message defaultValue:@""];
    ...
    NSString* detailMessage = [ZTUtil safeString:self.detailMessage defaultValue:@""];
...
- (UIButton*)button{
    if (!_button) {
        ...
        _button.layer.borderColor = [UIColorFromRGB(0x00b6f8) CGColor];
        ...
        [_button setTitleColor:UIColorFromRGB(0x00b6f8)
